            ...
            <div class="header-logo-menu">
                ...
                <div class="nav">
                    <ul class="menu">
                        ...
                        <li class="menu-item"><a href="{{ route('soup') }}" class="active">Супы</a></li>
                ...
                <div class="nav-mobile">
                    ...
                    <li class="nav-mobile-item"><a href="{{ route('soup') }}" class="active">Супы</a></li>
                ...
                <div class="orders-for-menu">
                    <div class="orders-text">
                        <p style="padding-bottom: 1rem">Ваш заказ:</p>
                        @if(Cart::count() !== 0)
                            @php $carts = Cart::content(); @endphp
                            @foreach($carts as $cart)
                                <p>
                                    <a href="{{ route('cart.delete', $cart->rowId) }}" class="delete-span">x</a>
                                    <span style="padding-bottom: 1rem; font-size: 1.1rem; line-height: 1.1rem">{{ $cart->name }}</span>
                                    <span style="padding-bottom: 1rem; font-size: 1.1rem; line-height: 1.1rem">{{ $cart->price }} р.</span>
                                </p>
                            @endforeach
                        <hr style="margin-top: .2em; margin-bottom: .2em;">
                        <p>
                            <a href="{{ route('cart.destroy') }}" class="delete-span">x</a>
                            <span style="padding-bottom: 1rem; font-size: 1.1rem; line-height: 1.1rem">Всего:</span>
                            <span style="padding-bottom: 1rem; font-size: 1.1rem; line-height: 1.1rem">{{ Cart::total() }} р.</span>
                        </p>
                        @else
                            <p style="font-size: .9rem; padding-bottom: 1rem">Добавте вкусную еду</p>
                        @endif
                    </div>
                    <div class="orders-links">
                        @if(Cart::count() !== 0)
                            <a href="{{ route('wishlist') }}">Заказать</a>
                        @endif
                    </div>
                </div>
