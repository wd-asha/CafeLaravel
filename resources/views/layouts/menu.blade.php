            ...
            <div class="header-logo-menu">
                ...
                <div class="nav">
                    <ul class="menu">
                        ...
                        <li class="menu-item"><a href="{{ route('menu') }}" class="active">Меню</a></li>
                ...
                <div class="nav-mobile">
                    ...
                    <li class="nav-mobile-item"><a href="{{ route('menu') }}" class="active">Меню</a></li>
                ...
                <div class="orders-for-menu">
                    <div class="orders-text">
                        ...
                        @else
                            <p style="font-size: 1rem; padding-bottom: 1rem">Добавте вкусную еду</p>
                        @endif
                    </div>
