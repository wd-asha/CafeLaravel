...
@section('content')
    ...
    <div class="card pd-20 pd-sm-40 mg-t-50 m-5">
        <h6 class="card-body-title">Редактирование столика (ID {{ $table->id }})</h6>
                ...
                <div class="row mg-b-25">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" placeholder="Наименование столика" value="{{$table->name}}"><br>
                        </div>
                    </div>
                </div>
