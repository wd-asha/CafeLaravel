...
@section('content')
    ...
    <div class="card pd-20 pd-sm-40 mg-t-50 m-5">
        <h6 class="card-body-title">Новое время</h6>

        <form action="{{ route('hour.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mg-b-25">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="day_of_week" placeholder="День недели"><br>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="time" name="open_time" placeholder="Начало работы"><br>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="time" name="close_time" placeholder="Окончание работы"><br>
                    </div>
                </div>
